...
//Create Customer
  ...
  DropdownButton<String> getResult(List<CustomerModel> model) {
    List<DropdownMenuItem<String>> dropDownItems = [const DropdownMenuItem(value: 'Guest', child: Text('Fornecedor Padrão'))];
                                                          ...
                                                          Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(
                                                                width: 70,
                                                                child: Text(
                                                                  myFormat.format(double.tryParse(double.parse(cartList[index].productPurchasePrice).toStringAsFixed(2)) ?? 0),
                                                                  style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold),
                                                                ),
                                                              ),
                                            ...
                                            child: Column(
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Produtos Totais: ${cartList.length}',
                                                      style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold),
                                                    ),
                                                    const Spacer(),
                                                    SizedBox(
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Center(
                                                          child: Text(
                                                            " ${myFormat.format(double.tryParse((getTotalAmount().toDouble() - discountAmount).toStringAsFixed(2)) ?? 0)} $currency",
                                                      ...
                                                      child: Container(
                                                        ...
                                                        () async {
                                                          if (await Subscription.subscriptionChecker(item: 'Purchase')) {
                                                            ...
                                                            bool result = await  PurchaseShowPaymentPopUp(
                                                                transitionModel: transitionModel,
                                                              ).launch(context);

                                                              if(result){
                                                                Navigator.pushReplacementNamed(context, Purchase.route);
                                                              }
                                                            }
                                                          } else {
                                                            EasyLoading.showError('Atualize seu plano primeiro\nO limite de compras acabou.');
                                                          }
                                                        },
                                                      ),
                                                    ),
