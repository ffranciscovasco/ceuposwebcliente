                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                '${myFormat.format(double.tryParse(calculateAllExpense(allExpense: expenses.value ?? []).toString()) ?? 0)} $currency',
                                            ...
                                            Container(
                                              ...
                                              child: AppTextField(
                                                ...
                                                decoration: kInputDecoration.copyWith(
                                                  ...
                                                  hintText: ('Pesquisar por nr fatura ...'),
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: const Row(
                                                      ...
                                                      children: [
                                                        SizedBox(width: 50, child: Text('Nr')),
                                                        SizedBox(width: 78, child: Text('Data')),
                                                        SizedBox(width: 150, child: Text('Descrição')),
                                                        SizedBox(width: 100, child: Text('categoria')),
                                                        SizedBox(width: 150, child: Text('Nota')),
                                                        SizedBox(width: 100, child: Text('Tipo de pagamento')),
                                                        SizedBox(width: 70, child: Text('Valor')),
