...
class AddCustomer extends StatefulWidget {
  const AddCustomer({super.key, required this.typeOfCustomerAdd, required this.listOfPhoneNumber, required this.sideBarNumber});
...
class _AddCustomerState extends State<AddCustomer> {
  ...
  Future<void> uploadFile() async {
    if (kIsWeb) {
      try {
        ...
        EasyLoading.showSuccess('Carregamento bem-sucedido!!');
        setState(() {
  ...
  String pageName = 'Adicionar Cliente';
                                                    ...
                                                    Expanded(
                                                      child: TextFormField(
                                                        ...
                                                        decoration: kInputDecoration.copyWith(
                                                          ...
                                                          hintText: 'Insira o nome do cliente/fornecedor',
                                                      ...
                                                      child: TextFormField(
                                                        validator: (value) {
                                                          if (value.isEmptyOrNull) {
                                                            ...
                                                            return 'O número de telefone já existe';
                                                    ...
                                                    Expanded(
                                                      child: TextFormField(
                                                        ...
                                                        decoration: kInputDecoration.copyWith(
                                                          labelText: 'Nuit',
                                                          labelStyle: kTextStyle.copyWith(color: kTitleColor),
                                                          hintText: 'Insira o número  do cliente/fornecedor',
                                                          hintStyle: kTextStyle.copyWith(color: kGreyTextColor),
                                                        ),
                                                      ),
                                                    ),
                                                            ...
                                                            : () async {
                                                                if (!isDemo) {
                                                                  if (await checkUserRolePermission(type: 'parties') &&
                                                                      await checkUserSubscriptionValidity(action: SubscriptionActionType.parties)) {
                                                                    if (validateAndSave()) {
                                                                      try {
                                                                        setState(() {
