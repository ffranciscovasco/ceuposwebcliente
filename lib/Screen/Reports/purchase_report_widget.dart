                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${myFormat.format(double.tryParse(calculateTotalDue(reTransaction).toString()) ?? 0)} $currency',
                                style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold, fontSize: 18.0),
                              ),
                              Text(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${myFormat.format(double.tryParse(calculateTotalPurchase(reTransaction).toString()) ?? 0)} $currency',
                                style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold, fontSize: 18.0),
                              ),
                              Text(
