                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppTextField(
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'O nome do usuário não pode ficar vazio';
                          }
                          return null;
                        },
                        showCursor: true,
                        ...
                        decoration: kInputDecoration.copyWith(
                          ...
                          hintText: 'Escreva o nome do usuário',
                          contentPadding: const EdgeInsets.all(10.0),
                          errorBorder: const OutlineInputBorder(borderSide: BorderSide(color: Colors.red)),
                          enabledBorder: const OutlineInputBorder(
                            borderRadius: BorderRadius.all(
                      ...
                      AppTextField(
                        ...
                        decoration: kInputDecoration.copyWith(
                          labelText: 'Função do usuário',
                          hintText: 'Insira a função do usuário',
                          contentPadding: const EdgeInsets.all(10.0),
                          errorBorder: const OutlineInputBorder(borderSide: BorderSide(color: Colors.red)),
                          enabledBorder: const OutlineInputBorder(
                            borderRadius: BorderRadius.all(
                      ...
                      TextButton(
                        onPressed: () async {
                          try {
                            ...
                            EasyLoading.showSuccess('Um e-mail foi enviado Verifique sua caixa de entrada');
                            setState(() {
                              isMailSent = true;
                            });
                          } catch (e) {
                    ...
                    onPressed: (() async {
                      if (salePermission ||
                        ...
                        try {
                          ...
                          EasyLoading.showSuccess('Atualizado com sucesso', duration: const Duration(milliseconds: 500));
                        ...
                        EasyLoading.showError('Selecione as permissões a serem concedidas primeiro!!');
                      }
                    }),
                    buttonTextColor: Colors.white),
              ),
  ...
  try {
    ...
    if (FirebaseAuth.instance.currentUser == null) {
      try {
        ...
        EasyLoading.showSuccess('Excluído com sucesso');
        // ignore: use_build_context_synchronously
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Você precisa fazer LOGIN novamente em sua conta.',
